...
class options(baseUIClass):
    ...
    def construct(self, pagebgnd):
        ...
        label.grid(row=5, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"], pady=(self.uiparts.scaling["10"], 0))
        self.labels.append(label)
        label = tb.Label(self.frame, text="Files created by this program are written here.", font=("Segoe UI", 10), justify='left')
        label.grid(row=6, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"])
        self.labels.append(label)
        label = tb.Button(self.frame, text="Browse", bootstyle="primary", command=self.pickOutputsDir)
        label.grid(row=7, column=0, sticky="w", padx=self.uiparts.scaling["20"], pady=self.uiparts.scaling["10"])
        self.labels.append(label)
        ...
        label.grid(row=9, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"], pady=(self.uiparts.scaling["10"], 0))
        self.labels.append(label)
        label = tb.Label(self.frame, text="This is where .PBN files are located.", font=("Segoe UI", 10), justify='left')
        label.grid(row=10, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"])
        self.labels.append(label)
        label = tb.Button(self.frame, text="Browse", bootstyle="primary", command=self.pickHandRecDir)
        label.grid(row=11, column=0, sticky="w", padx=self.uiparts.scaling["20"], pady=self.uiparts.scaling["10"])
        self.labels.append(label)
        ...
        label.grid(row=14, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"], pady=(0, self.uiparts.scaling["5"]))
        self.labels.append(label)
        label = tb.Button(self.frame, text="Browse", bootstyle="primary", command=self.pickTemplate)
        label.grid(row=15, column=0, sticky="w", padx=self.uiparts.scaling["20"])
        self.labels.append(label)
        ...
        label.grid(row=17, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"], pady=(self.uiparts.scaling["15"], 0))
        self.labels.append(label)
        ...
        label.grid(row=18, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"], pady=(0, self.uiparts.scaling["5"]))
        self.labels.append(label)
        label = tb.Label(self.frame, text="Stratum A is the overall rankings (all pairs).", font=("Segoe UI", 10), justify='left')
        label.grid(row=19, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"])
        self.labels.append(label)
        label = tb.Label(self.frame, text="Stratum B is all pairs at or below the selected B rank.", font=("Segoe UI", 10), justify='left')
        label.grid(row=20, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"])
        self.labels.append(label)
        ...
        label.grid(row=23, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["25"], pady=(self.uiparts.scaling["10"], 0))
        self.labels.append(label)
        ...
        self.cb1.grid(row=23, column=0, padx=self.uiparts.scaling["200"], sticky="w", pady=(self.uiparts.scaling["10"], 0))
        self.labels.append(self.cb1)
        
        label = tb.Label(self.frame, text="Highest rank in Stratum C", font=("Segoe UI", 10), justify='right')
        label.grid(row=24, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["25"])
        self.labels.append(label)
        ...
        self.cb2.grid(row=24, column=0, padx=self.uiparts.scaling["200"], sticky="w")
