...
class webpage(baseUIClass):
    ...
    def construct(self, pagebgnd: str):
        ...
        label.grid(row=8, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"], pady=(self.uiparts.scaling["10"], 0))
        self.labels.append(label)
        ...
        label.grid(row=9, column=0, sticky="w", padx=self.uiparts.scaling["100"])
        self.labels.append(label)
        ...
        label.grid(row=10, column=0, sticky="w", padx=self.uiparts.scaling["100"])
        self.labels.append(label)

        self.createButton = tb.Button(self.frame, text="Create", bootstyle="primary", command=lambda: self.createWrapper())
        self.createButton.grid(row=11, column=0, sticky="w", padx=self.uiparts.scaling["20"], pady=(self.uiparts.scaling["20"], self.uiparts.scaling["10"]))
        ...
        self.messageLabel.grid(row=12, column=0, columnspan=2, sticky="w", padx=self.uiparts.scaling["20"], pady=(self.uiparts.scaling["10"], 0))
