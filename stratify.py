...
class stratify(baseUIClass):
    ...
    def construct(self, pagebgnd):
        ...
        self.labels.append(label)
        self.maxRankContentLabel = tb.Label(self.frame, textvariable=self.maxRankText, font=("Segoe UI", 10), justify='left')
        self.maxRankContentLabel.grid(row=1, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(self.maxRankContentLabel)
        label = tb.Label(self.frame, text="Lowest Rank", font=("Segoe UI", 10), justify='left')
        label.grid(row=2, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(label)   
        self.minRankContentLabel = tb.Label(self.frame, textvariable=self.minRankText, font=("Segoe UI", 10), justify='left')
        self.minRankContentLabel.grid(row=2, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(self.minRankContentLabel)

        label = tb.Label(self.frame, text="Stratification Split", font=("Segoe UI", 10, "bold"), justify='left')
        label.grid(row=4, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(label)
        self.overallNSStringLabel = tb.Label(self.frame, textvariable=self.overallNSString, font=("Segoe UI", 10), justify='left')
        self.overallNSStringLabel.grid(row=5, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(self.overallNSStringLabel)
        label = tb.Label(self.frame, textvariable=self.overallNSPairs, font=("Segoe UI", 10), justify='left')
        label.grid(row=5, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(label)
        self.overallEWStringLabel = tb.Label(self.frame, textvariable=self.overallEWString, font=("Segoe UI", 10), justify='left')
        self.overallEWStringLabel.grid(row=6, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(self.overallEWStringLabel)
        label = tb.Label(self.frame, textvariable=self.overallEWPairs, font=("Segoe UI", 10), justify='left')
        label.grid(row=6, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(label)
        self.strat1NSStringLabel = tb.Label(self.frame, textvariable=self.strat1NSString, font=("Segoe UI", 10), justify='left')
        self.strat1NSStringLabel.grid(row=7, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(self.strat1NSStringLabel)
        label = tb.Label(self.frame, textvariable=self.strat1NSPairs, font=("Segoe UI", 10), justify='left')
        label.grid(row=7, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(label)
        self.strat1EWStringLabel = tb.Label(self.frame, textvariable=self.strat1EWString, font=("Segoe UI", 10), justify='left')
        self.strat1EWStringLabel.grid(row=8, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(self.strat1EWStringLabel)
        label = tb.Label(self.frame, textvariable=self.strat1EWPairs, font=("Segoe UI", 10), justify='left')
        label.grid(row=8, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(label)
        self.strat2NSStringLabel = tb.Label(self.frame, textvariable=self.strat2NSString, font=("Segoe UI", 10), justify='left')
        self.strat2NSStringLabel.grid(row=9, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(self.strat2NSStringLabel)
        label = tb.Label(self.frame, textvariable=self.strat2NSPairs, font=("Segoe UI", 10), justify='left')
        label.grid(row=9, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(label)
        self.strat2EWStringLabel = tb.Label(self.frame, textvariable=self.strat2EWString, font=("Segoe UI", 10), justify='left')
        self.strat2EWStringLabel.grid(row=10, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(self.strat2EWStringLabel)
        label = tb.Label(self.frame, textvariable=self.strat2EWPairs, font=("Segoe UI", 10), justify='left')
        label.grid(row=10, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(label)

        label = tb.Label(self.frame, text="Stratification Results", font=("Segoe UI", 10, "bold"), justify='left')
        label.grid(row=12, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(label)
        label = tb.Label(self.frame, text='Stratum A Masterpoints:', font=("Segoe UI", 10), justify='left')
        label.grid(row=13, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(label)
        label = tb.Label(self.frame, textvariable=self.resultsAmps, font=("Segoe UI", 10), justify='left')
        label.grid(row=13, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(label)
        label = tb.Label(self.frame, text='Stratum B Masterpoints:', font=("Segoe UI", 10), justify='left')
        label.grid(row=14, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(label)
        label = tb.Label(self.frame, textvariable=self.resultsBmps, font=("Segoe UI", 10), justify='left')
        label.grid(row=14, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(label)
        label = tb.Label(self.frame, text='Stratum C Masterpoints:', font=("Segoe UI", 10), justify='left')
        label.grid(row=15, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(label)
        label = tb.Label(self.frame, textvariable=self.resultsCmps, font=("Segoe UI", 10), justify='left')
        label.grid(row=15, column=4, sticky="w", padx=RIGHT_TEXT_MARGIN)
        self.labels.append(label)

        label = tb.Label(self.frame, text="Click Stratify to apply this stratification.", font=("Segoe UI", 10, "bold"), justify='left')
        label.grid(row=17, column=4, sticky="w", padx=LEFT_TEXT_MARGIN)
        self.labels.append(label)
        ...
        self.statusLabel.grid(row=21, column=4, columnspan=2, sticky="w", padx=LEFT_TEXT_MARGIN)
